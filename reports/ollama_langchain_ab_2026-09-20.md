...
This measures the LLM path only (`eval/benchmark_ollama_waiter.py`): it calls `OllamaWaiterAgent.respond()`
...
Raw per-run data, including every reply and tool call, is in `ollama_langchain_ab_2026-09-20/`.
