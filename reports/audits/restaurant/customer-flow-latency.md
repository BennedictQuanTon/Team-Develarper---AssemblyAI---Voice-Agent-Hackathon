...
>
> *Dữ liệu nguồn gốc*: Trích xuất từ bài test 6-turn End-to-End thực tế tại [`historical realtime-waiter turns`](../../restaurant/realtime-waiter/historical-pre-2026-09-13/turns.json).
...
2. **Kịch bản chẩn đoán regression (`eval/benchmarks/restaurant/regression_vs_baseline.py`):**
...
- **Script benchmark**: [`regression_vs_baseline.py`](../../../eval/benchmarks/restaurant/regression_vs_baseline.py)
- **Baseline JSON**: [`historical realtime-waiter turns`](../../restaurant/realtime-waiter/historical-pre-2026-09-13/turns.json)
- **New generated results**: `reports/restaurant/regression-vs-baseline/<run-id>/results.json`
