...
Outputs an immutable restaurant/llm-provider-comparison run directory.
"""
...
async def main():
    run = create_run(product="restaurant", suite="llm-provider-comparison")
    print("==================================================================")
    ...
    json_path = write_results(run, report_data)
