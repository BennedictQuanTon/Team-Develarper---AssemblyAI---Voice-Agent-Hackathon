...
Outputs an immutable restaurant/simplified-two-turn run directory.
"""
...
async def main():
    run = create_run(product="restaurant", suite="simplified-two-turn")
    print("==================================================================")
    ...
    # Write JSON report
    json_path = write_results(run, overall_evaluation)
...
> **Dữ liệu JSON gốc**: [`results.json`](results.json)
