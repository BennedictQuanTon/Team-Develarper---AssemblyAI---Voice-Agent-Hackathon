# The Lantern UI Design System

Warm, calm, and operationally clear for restaurant voice ordering.

## Overview

The Lantern interface supports guests placing an order by voice while allowing staff to verify the live basket, table, connection status, and fulfillment phase at a glance. It uses generous whitespace and a warm, neutral palette, but the primary design priority is legibility of restaurant state rather than long-form reading.
